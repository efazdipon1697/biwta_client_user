...
const HydrographicSurveyChartReply = () => {
    ...
    function getMyHydrographicSurveyChartRequest() {
        ...
        var url = "https://biwta-db.000webhostapp.com/user/biwta_reply/hydrographic_survey_chart.php?email=" + currentEmail;
        ...
        axios.get(url)
            .then((response) => {
                ...
                response.data.map((data, index) => (
                    tempRows.push({ id: data.id, area: data.area, river: data.river, latitude: data, longitude: data, scale: data.scale, purpose: data.purpose, period: data.period, status: data.status, action: data})
                ));
                setRows(tempRows);
            });
        }
    ...
    function order() {
        ...
        axios.post('https://biwta-db.000webhostapp.com/user/biwta_reply/purchase_hydrographic_survey_data.php', fd)
        .then(res=> {
...
export default HydrographicSurveyChartReply;

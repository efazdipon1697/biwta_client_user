...
const TidalTableBookReply = () => {
    ...
    function getMyTidalTableBookRequest() {
        ...
        var url = "https://biwta-db.000webhostapp.com/user/biwta_reply/tidal_table_book.php?email=" + currentEmail;
    ...
    function order() {
        ...
        axios.post('https://biwta-db.000webhostapp.com/user/biwta_reply/purchase_tidal_table_book.php', fd)
        .then(res=> {

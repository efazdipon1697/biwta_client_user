        ...
        axios.get(url)
            .then((response) => {
                ...
                response.data.map((data, index) => (
                    tempRows.push({ id: data.id, tidalDataType: data.tidalDataType, district: data.district, river: data.river, station: data.station, from: data.fromDate, to: data.toDate, purpose: data.purpose, status: data.status, action: data})
                ));
                setRows(tempRows);
            });
        }
